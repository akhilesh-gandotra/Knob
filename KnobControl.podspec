...
spec.homepage     = "http://raywenderlich.com"
  ...
  spec.author             = { "Akhilesh Gandotra" => "akhilesh.gandotra@go-jek.com" }
  # Or just: spec.author    = "Akhilesh Gandotra"
  # spec.authors            = { "Akhilesh Gandotra" => "akhilesh.gandotra@go-jek.com" }
  # spec.social_media_url   = "https://twitter.com/Akhilesh Gandotra"
...
spec.source       = { :git => "https://github.com/akhilesh-gandotra/Knob.git", :tag => "#{spec.version}" }
